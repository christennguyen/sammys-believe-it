  ...
  return (
    <SectionCard>
      ...
      <div>
        ...
        2021. The two protaganists go on date after date to discover that they
        share a love for similar things in life. Soon enough, they find
        themselves embarking on adventures of music, food, and travel. More than
